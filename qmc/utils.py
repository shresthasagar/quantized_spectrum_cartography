...
# Bin boundaries computed by equal number of datasets in all bins using the raw data points
...
# Equally spaced bin boundaries from 0 to the maximum data point in the sample dataset
...
# Bin boundaries computed such that all bins consist of equal number of data points ( Log of the data points are considered )
...
QUANTIZATION_BOUNDARIES_4_BINS_LOG =   [-23.025850296020508, -10.002398490905762, -7.980128765106201, -6.692554473876953, -1.0331487655639648]
LOG_OFFSET_4 = 1e-10
SD_4_BINS_LOG = 1.287


# Bin boundaries computed by estimating an offset parameter, 
# i.e., first y = log(f + x) is fitted to the data points 
# x -> data point value
# f -> offset parameter to be estimated
# y -> assigned level (e.g., max value will be assined level 8 if 3 bits are used)
